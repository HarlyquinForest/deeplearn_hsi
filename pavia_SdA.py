...
# load .mat files
hsi_file = 'datasets/PaviaU.mat'
gnd_file = 'datasets/PaviaU_gt.mat'
...
print(training_epochs , n_train_batches)
...
imageio.imwrite(filename + '_wholeimg.png' , y_image)
...
for i in range(num_test):
    ...
    train_valid_test(data, ratio=[0, 1, 1], batch_size=1, 
                     random_state=numpy_rng.randint(2**30))
